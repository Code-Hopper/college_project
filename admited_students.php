...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['student_search'])) {
    ...
    $sql = "SELECT * FROM admission_forms WHERE accepted = '1'";
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            if ($searchResult) {
                ...
                $sqlAll = "SELECT * FROM admission_forms WHERE accepted= '1'";
                ...
                if ($resultAll->num_rows > 0) {
                    while ($rowAll = $resultAll->fetch_assoc()) {
                        ...
                        echo "<td>" . $rowAll["student_email"] . "</td>";
                        echo "<td>" . $rowAll["education"] . "</td>";
                        echo "<td>" . $rowAll["course"] . "</td>";
                        echo "<td>" . $rowAll["interests"] . "</td>";
                        echo "<td>" . $rowAll["ssc_marks"] . "</td>";
                        echo "<td>" . $rowAll["hsc_marks"] . "</td>";
                        echo "<td>" . $rowAll["graduation"] . "</td>";
                        echo "<td class='fw-bold text-success'> Accepted </td>";
                        echo "</tr>";
                    }
                } else {
